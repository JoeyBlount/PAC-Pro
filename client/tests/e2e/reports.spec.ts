...
test.describe('Reports Tests', () => {
  test('should hover reports icon to open mini menu and print PAC and Invoice Log reports', async () => {
    ...
    await expect(page).toHaveTitle(/PAC Pro - Reports/i);
    ...
    await page.locator('[role="dialog"]').locator('select').first().selectOption('December');
    await page.locator('[role="dialog"]').locator('select').nth(1).selectOption('2024');
    ...
    // Set specific date (December 2024)
    await page.locator('[role="dialog"]').locator('select').first().selectOption('12');
    await page.locator('[role="dialog"]').locator('select').nth(1).selectOption('2024');
